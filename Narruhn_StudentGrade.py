...
if FinalGrade <=100 and FinalGrade >=99:
    print(f"\nYour final grade is {FinalGrade}, You have a 1.00 Grade Points, Excellent!")
elif FinalGrade >=96 and FinalGrade <=98:
    print(f"\nYour final grade is {FinalGrade}, You have a 1.25 Grade Points, Outstanind!")
elif FinalGrade >=93 and FinalGrade <=95:
    print(f"\nYour final grade is {FinalGrade}, You have a 1.50 Grade Points, Superior!")
elif FinalGrade >=90 and FinalGrade <=92:
    print(f"\nYour final grade is {FinalGrade}, You have a 1.75 Grade Points, Very Good!")
elif FinalGrade >=87 and FinalGrade <=89:
    print(f"\nYour final grade is {FinalGrade}, You have a 2.00 Grade Points, Good!")
elif FinalGrade >=84 and FinalGrade <=86:
    print(f"\nYour final grade is {FinalGrade}, You have a 2.25 Grade Points, Satisfactory!")
elif FinalGrade >=81 and FinalGrade <=83:
    print(f"\nYour final grade is {FinalGrade}, You have a 2.50 Grade Points, Fairly Satisfactory!")
elif FinalGrade >=78 and FinalGrade <=80:
    print(f"\nYour final grade is {FinalGrade}, You have a 2.75 Grade Points, Fair!")
elif FinalGrade >=75 and FinalGrade <=77:
    print(f"\nYour final grade is {FinalGrade}, You have a 3.00 Grade Points, Passed!")
elif FinalGrade <75 and FinalGrade >=40:
    print(f"\nYour final grade is {FinalGrade}, You have a 5.00 Grade Points, Failed")
else: print("\nError")
